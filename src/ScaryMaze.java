...
int m = -16777216;
		...
		if(mouseColor == -1){
			scare();
			JOptionPane.showMessageDialog(null, "HORROR!!!");
...
if(mouseColor == -131072){
	JOptionPane.showMessageDialog(null, "YOU WON!!! YAY FIREWORKS!!!! YAYAYAYAYYAYAY MORE FIREWORKS!! you Quit this tab Now MORE FIRE WORKS YAYAYAYAY");
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Scary Scream-SoundBible.com-1115384336.wav"));
